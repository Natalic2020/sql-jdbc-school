...
public class AuxiliaryValue {
    ...
    public String[] courses() {
        String[] courses = { "maths", "history", "geography", "literature", "sport", "music", "biology", "art",
    ...
    public List<Map<String, String>> fillNames() {
        ...
        List<Map<String, String>> nameArray = namesNoDouble.stream().map(this::addName).collect(Collectors.toList());
        return nameArray;
    }
    ...
    public List<Integer[]> recieveCourcesOfStudents() {
        ...
        students.forEach(data -> receiveCourses(courcesOfStudents, courses, data));
